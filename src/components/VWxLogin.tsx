  ...
  (props: Props) => {
    ...
    return () => (
      <van-popup
        ...
        <div class='bg-white w-[600px] flex flex-col items-center justify-center p-[60px] pl-0 pr-0 rounded-[10px]'>
          <p class='mb-[40px] text-[32px]'>您还没有登录</p>
          <p class='mb-[40px] text-[32px]'>点击微信一键登录参与活动</p>
          <div
            class='bg-[#12c164] w-[500px] flex items-center justify-center text-white h-[80px] rounded-[12px]'
            onClick={openLink}>
            <svg
